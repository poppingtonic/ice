...
from .adherence_simple import AdherenceSimpleAnthropic
...
from .placebo_description import PlaceboDescriptionAnthropic
...
from .placebo_simple import PlaceboSimpleAnthropic
...
def get_recipe_classes() -> list[Type[Recipe]]:
    return [
        ...
        HelloWorld,
        PaperQA,
        PlaceboDescriptionAnthropic,
        PlaceboDescriptionInstruct,
        PlaceboDialogs,
        PlaceboKeywordBaseline,
        PlaceboSimpleAnthropic,
